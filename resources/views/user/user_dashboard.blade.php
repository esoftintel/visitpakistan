...
<div class="breadcrumb-wrapper content_above">
    ...
    <section class="dashboard-wrapper section-bg p-bottom-70">
                    ...
                    <div class="col-lg-12">
                        <div class="dashboard-nav-area">
                            <ul class="nav" id="dashboard-tabs" role="tablist">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link " id="all-forum" data-toggle="tab" href="#forums" role="tab" aria-controls="forums" aria-selected="true">My Forums</a>
                                </li>
                                <li class="nav-item">
        ...
        <div class="tab-content p-top-100" id="dashboard-tabs-content">
            ...
            <div class="tab-pane fade show active" id="forums" role="tabpanel" aria-labelledby="all-forums">
                <div class="container">
                    <div class="row">
                    @if(count($post_data)>0 )
